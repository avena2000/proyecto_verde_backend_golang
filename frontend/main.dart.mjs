...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm} = {}) {
    ...
    const dart2wasm = {
      ...
      _1626: x0 => x0.remove(),
      _1627: (x0,x1,x2,x3) => x0.drawImage(x1,x2,x3),
      _1628: x0 => globalThis.URL.createObjectURL(x0),
      _1629: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1629(f,arguments.length,x0) }),
      _1630: (x0,x1,x2,x3) => x0.toBlob(x1,x2,x3),
      _1631: x0 => x0.remove(),
      _1632: x0 => globalThis.URL.createObjectURL(x0),
      ...
      _1637: (x0,x1) => x0.createElement(x1),
      _1638: (x0,x1) => x0.append(x1),
      _1639: (x0,x1,x2) => x0.setAttribute(x1,x2),
      _1640: (x0,x1) => x0.replaceChildren(x1),
      _1641: (x0,x1) => x0.append(x1),
      _1642: x0 => x0.click(),
      ...
      _1666: x0 => x0.stop(),
      _1667: () => globalThis.Notification.requestPermission(),
      ...
      _1670: (x0,x1,x2) => x0.getCurrentPosition(x1,x2),
      _1673: () => globalThis.removeSplashFromWeb(),
      _1674: () => globalThis.getLaunchMode(),
      _1675: () => globalThis.promptInstall(),
      _1676: f => finalizeWrapper(f, function() { return dartInstance.exports._1676(f,arguments.length) }),
      _1677: f => finalizeWrapper(f, function() { return dartInstance.exports._1677(f,arguments.length) }),
      _1678: f => finalizeWrapper(f, function() { return dartInstance.exports._1678(f,arguments.length) }),
      _1679: f => finalizeWrapper(f, function() { return dartInstance.exports._1679(f,arguments.length) }),
      _1680: f => finalizeWrapper(f, function() { return dartInstance.exports._1680(f,arguments.length) }),
      _1681: x0 => globalThis.appLaunchedAsPWA = x0,
      _1682: x0 => globalThis.appLaunchedAsTWA = x0,
      _1683: x0 => globalThis.hasPrompt = x0,
      _1685: x0 => globalThis.appInstalled = x0,
      _1686: x0 => globalThis.appLaunchedInBrowser = x0,
      ...
      _1757: (decoder, codeUnits) => decoder.decode(codeUnits),
      _1758: () => new TextDecoder("utf-8", {fatal: true}),
      _1759: () => new TextDecoder("utf-8", {fatal: false}),
      _1760: x0 => new WeakRef(x0),
      _1761: x0 => x0.deref(),
      _1767: Date.now,
      _1769: s => new Date(s * 1000).getTimezoneOffset() * 60,
      _1770: s => {
      ...
      _1772: () => typeof dartUseDateNowForTicks !== "undefined",
      _1773: () => 1000 * performance.now(),
      _1774: () => Date.now(),
      _1775: () => {
      ...
      _1777: () => new WeakMap(),
      _1778: (map, o) => map.get(o),
      _1779: (map, o, v) => map.set(o, v),
      _1780: () => globalThis.WeakRef,
      _1791: s => JSON.stringify(s),
      _1792: s => printToConsole(s),
      _1793: a => a.join(''),
      _1794: (o, a, b) => o.replace(a, b),
      _1796: (s, t) => s.split(t),
      _1797: s => s.toLowerCase(),
      _1798: s => s.toUpperCase(),
      _1799: s => s.trim(),
      _1800: s => s.trimLeft(),
      _1801: s => s.trimRight(),
      _1803: (s, p, i) => s.indexOf(p, i),
      _1804: (s, p, i) => s.lastIndexOf(p, i),
      _1805: (s) => s.replace(/\$/g, "$$$$"),
      _1806: Object.is,
      _1807: s => s.toUpperCase(),
      _1808: s => s.toLowerCase(),
      _1809: (a, i) => a.push(i),
      _1812: (a, l) => a.length = l,
      _1813: a => a.pop(),
      _1814: (a, i) => a.splice(i, 1),
      _1816: (a, s) => a.join(s),
      _1817: (a, s, e) => a.slice(s, e),
      _1819: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1820: a => a.length,
      _1822: (a, i) => a[i],
      _1823: (a, i, v) => a[i] = v,
      _1825: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1826: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      ...
      _1829: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1830: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1831: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1832: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1834: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1835: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1836: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1837: (t, s) => t.set(s),
      _1838: l => new DataView(new ArrayBuffer(l)),
      _1839: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1841: o => o.buffer,
      _1842: o => o.byteOffset,
      _1843: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1844: (b, o) => new DataView(b, o),
      _1845: (b, o, l) => new DataView(b, o, l),
      _1846: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1847: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1848: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1849: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1850: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1851: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1852: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1853: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1854: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1855: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1856: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1857: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1860: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1861: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1862: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1863: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1864: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1865: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1878: () => new XMLHttpRequest(),
      _1879: (x0,x1,x2) => x0.open(x1,x2),
      ...
      _1884: x0 => x0.abort(),
      _1885: x0 => x0.abort(),
      _1886: (x0,x1) => x0.send(x1),
      _1887: x0 => x0.send(),
      _1889: x0 => x0.getAllResponseHeaders(),
      _1890: (o, t) => o instanceof t,
      ...
      _1896: (handle) => clearTimeout(handle),
      _1897: (ms, c) =>
      setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
      _1898: (handle) => clearInterval(handle),
      _1899: (c) =>
      queueMicrotask(() => dartInstance.exports.$invokeCallback(c)),
      _1900: () => Date.now(),
      _1901: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1902: (x0,x1,x2) => x0.fetch(x1,x2),
      _1903: (x0,x1) => x0.get(x1),
      _1904: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1904(f,arguments.length,x0,x1,x2) }),
      _1905: (x0,x1) => x0.forEach(x1),
      _1906: x0 => x0.abort(),
      _1907: () => new AbortController(),
      _1908: x0 => x0.getReader(),
      _1909: x0 => x0.read(),
      _1910: x0 => x0.cancel(),
      _1916: () => new XMLHttpRequest(),
      _1917: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1919: () => new FileReader(),
      _1920: (x0,x1) => x0.readAsArrayBuffer(x1),
      ...
      _1930: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      _1931: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      _1941: (x0,x1) => x0.key(x1),
      _1942: (x0,x1) => x0.item(x1),
      _1948: (x0,x1) => x0.getContext(x1),
      _1952: (x0,x1,x2,x3,x4,x5) => x0.drawImage(x1,x2,x3,x4,x5),
      _1958: (s, m) => {
        try {
      ...
      _1959: (x0,x1) => x0.exec(x1),
      _1960: (x0,x1) => x0.test(x1),
      _1961: (x0,x1) => x0.exec(x1),
      _1962: (x0,x1) => x0.exec(x1),
      _1963: x0 => x0.pop(),
      _1965: o => o === undefined,
      _1984: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
      _1986: o => {
        const proto = Object.getPrototypeOf(o);
        return proto === Object.prototype || proto === null;
      },
      _1987: o => o instanceof RegExp,
      _1988: (l, r) => l === r,
      _1989: o => o,
      _1990: o => o,
      _1991: o => o,
      ...
      _1998: l => arrayFromDartList(Int8Array, l),
      _1999: l => arrayFromDartList(Uint8Array, l),
      _2000: l => arrayFromDartList(Uint8ClampedArray, l),
      _2001: l => arrayFromDartList(Int16Array, l),
      _2002: l => arrayFromDartList(Uint16Array, l),
      _2003: l => arrayFromDartList(Int32Array, l),
      _2004: l => arrayFromDartList(Uint32Array, l),
      _2005: l => arrayFromDartList(Float32Array, l),
      _2006: l => arrayFromDartList(Float64Array, l),
      _2007: x0 => new ArrayBuffer(x0),
      _2008: (data, length) => {
      ...
      _2009: l => arrayFromDartList(Array, l),
      _2010: () => ({}),
      _2011: () => [],
      _2012: l => new Array(l),
      _2013: () => globalThis,
      ...
      _2036: x0 => x0.index,
      _2041: x0 => x0.flags,
      _2042: x0 => x0.multiline,
      _2043: x0 => x0.ignoreCase,
      _2044: x0 => x0.unicode,
      _2045: x0 => x0.dotAll,
      _2046: (x0,x1) => x0.lastIndex = x1,
      _2047: (o, p) => p in o,
      _2048: (o, p) => o[p],
      _2051: x0 => x0.random(),
      _2052: x0 => x0.random(),
      _2053: (x0,x1) => x0.getRandomValues(x1),
      _2054: () => globalThis.crypto,
      _2056: () => globalThis.Math,
      _2058: Function.prototype.call.bind(Number.prototype.toString),
      _2059: (d, digits) => d.toFixed(digits),
      _2166: x0 => x0.readyState,
      _2168: (x0,x1) => x0.timeout = x1,
      _2170: (x0,x1) => x0.withCredentials = x1,
      _2171: x0 => x0.upload,
      _2172: x0 => x0.responseURL,
      _2173: x0 => x0.status,
      _2174: x0 => x0.statusText,
      _2176: (x0,x1) => x0.responseType = x1,
      _2177: x0 => x0.response,
      _2191: x0 => x0.loaded,
      _2192: x0 => x0.total,
      _2270: (x0,x1) => x0.oncancel = x1,
      _2276: (x0,x1) => x0.onchange = x1,
      _2316: (x0,x1) => x0.onerror = x1,
      _2689: (x0,x1) => x0.src = x1,
      _2700: x0 => x0.width,
      _2702: x0 => x0.height,
      _3189: (x0,x1) => x0.accept = x1,
      _3203: x0 => x0.files,
      _3229: (x0,x1) => x0.multiple = x1,
      _3247: (x0,x1) => x0.type = x1,
      _3547: x0 => x0.width,
      _3548: (x0,x1) => x0.width = x1,
      _3549: x0 => x0.height,
      _3550: (x0,x1) => x0.height = x1,
      _3988: () => globalThis.window,
      _4034: x0 => x0.location,
      _4053: x0 => x0.navigator,
      _4317: x0 => x0.localStorage,
      _4425: x0 => x0.geolocation,
      _4428: x0 => x0.mediaDevices,
      _4430: x0 => x0.permissions,
      _4444: x0 => x0.userAgent,
      _4445: x0 => x0.vendor,
      _4664: x0 => x0.length,
      _6648: x0 => x0.type,
      _6649: x0 => x0.target,
      _6691: x0 => x0.signal,
      _6770: () => globalThis.document,
      _6863: x0 => x0.body,
      ...
      _8784: x0 => x0.type,
      _8791: x0 => x0.name,
      _8792: x0 => x0.lastModified,
      _8798: x0 => x0.length,
      _8809: x0 => x0.result,
      _9318: x0 => x0.url,
      _9320: x0 => x0.status,
      _9322: x0 => x0.statusText,
      _9323: x0 => x0.headers,
      _9324: x0 => x0.body,
      _9723: x0 => x0.state,
      _10129: x0 => x0.active,
      _11050: x0 => x0.coords,
      _11051: x0 => x0.timestamp,
      _11053: x0 => x0.accuracy,
      _11054: x0 => x0.latitude,
      _11055: x0 => x0.longitude,
      _11056: x0 => x0.altitude,
      _11057: x0 => x0.altitudeAccuracy,
      _11058: x0 => x0.heading,
      _11059: x0 => x0.speed,
      _11060: x0 => x0.code,
      _11061: x0 => x0.message,
